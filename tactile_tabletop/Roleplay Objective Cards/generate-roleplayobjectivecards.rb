...
Squib::Deck.new(dpi: 300, width: 1122, height: 822, cards: data['Name'].size, layout: 'roleplayobjectivecardlayout.yml')  do
...
Squib::Deck.new(dpi: 300, width: 1122, height: 822, cards: data['Name'].size, layout: 'roleplayobjectivecardlayout.yml')  do
  ...
  save_png prefix: 'r_objective_back_'
